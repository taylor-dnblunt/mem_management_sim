...
The main files for the assignment are holes.c, holes_func.c, holes.h, min_heap.c, README.txt, and the makefile
...
holes.c contains the main function and deals with taking the input file, setting the right flags for which
...
holes_func.c contains all the helper functions used in holes.c. Each strategy has its own insert function:
...
holes.h contains the structs as well as the function prototypes.
